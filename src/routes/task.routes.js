...
import { createTaskValidation,taskIdValidation, editarTaskValidation } from "../middlewares/validations/task.validation.js";
...
taskRoutes.put("/task/:id",editarTaskValidation,validate,editarTarea);
